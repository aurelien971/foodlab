      ...
      <div className="max-w-5xl mx-auto px-6 md:px-10">
        ...
        <div className="flex flex-col md:flex-row gap-10 items-start">
          <div className="flex-shrink-0 md:w-44">
            <h2
              className="font-display font-light leading-tight text-charcoal mb-1"
            ...
            <div className="flex flex-col gap-1">
              {countryGroups.map(({ country, flag }) => (
                <span
                  key={country}
                  className="font-body text-xs text-charcoal/55 flex items-center gap-1.5"
                >
            ...
            <div className="mt-5 flex flex-col gap-1 text-[10px] font-body text-charcoal/30">
              <div className="flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-sm bg-forest inline-block" />
                Active market
              </div>
              <div className="flex items-center gap-1.5">
          ...
          <div className="flex-1 min-w-0" style={{ lineHeight: 0 }}>
            ...
            >
              <Geographies geography={GEO_URL}>
                {({ geographies }) =>
                  geographies.map((geo) => {
                    const isActive = ACTIVE_COUNTRIES[String(geo.id)]
